...
$SQL = "SELECT id_Fase_IOS,id_Medio_Acceso,int_Documentado,dt_Fecha_Fase_IOS FROM tb_ios WHERE referencia = '".$referencia."' AND ser_n = '".$ser_n."'";
...
<!--funcion onclick construccion-->
  ...
  <tr>
    <td>Fase IOS ALE: </td>
    <td><?php echo ImprimeCombo(9,$id_Fase_IOS);?><input type="hidden" name="Fase_IOS_hidden" id="Fase_IOS_hidden" value="<?php echo $id_Fase_IOS; ?>" /></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>Fase IOS: </td>
