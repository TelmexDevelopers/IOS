...
if ($_SESSION["id_Area_Responsable"] == 4 && ($_SESSION["id_Usuario"] == 19 || $_SESSION["id_Usuario"] == 22))
{
?>
  ...
  <tr align="center">
    ...
    <table width="700" border="0" cellspacing="1" id="tabla_responsables" bgcolor="#999999">
      <tr align="center" bgcolor="#0066CC" class="Texto_Mediano_Blanco">
        ...
        <td><b>Opciones</b><input name="ultima_fila" type="text" id="ultima_fila" value="0" /><input name="filas_tabla" type="hidden" id="filas_tabla" value="0" /></td>
      </tr>
    </table>
    </form>
    </td>
...
<?php
	...
	echo '<script type="text/javascript">alert("Usted no esta permitido a acceder a esta pagina.");</script>';
	header("Location: http://10.94.130.36/iosphp/TELMEX_IOS/Busqueda_Principal/inicio.php");	
}
?>