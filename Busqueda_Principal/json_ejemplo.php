...
<form>
    <p>
        <select id='select1' onchange='cargarSelect2(this.value);'>
            ...
            <option value='1'>ANA VELIA	CERVANTES	GUEVARA</option>
            <option value='2'>LUIS	BERNARDO	GARCIA</option>
            <option value='3'>MIGUEL ERNESTO 	RUIZ	YANEZ</option>
            <option value='4'>SERGIO EDUARDO	LOPEZ	ARENAS</option>
        </select>
