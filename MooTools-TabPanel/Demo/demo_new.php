...
/*	$SQL_3 = "SELECT id_requerimiento, id_edo_acometida, dt_PROGRAMADA, id_supervisor_fo, id_resp_sucope, id_resp_ipr, dt_solicitud_fo, str_planificador, dt_sol_planificacion, dt_rec_planificacion, dt_sol_permiso_ssp, dt_rec_permiso, dt_entrega_fo, dt_ok_adecuaciones, delegacion, dt_elab_ot, dt_Entr_ot, str_recibe_OT, PEP_09, str_ped45, id_problematica, str_Constructor, dt_proyecto_Ok, id_cancel, FOt1, FOt2, clte_fo1, clte_fo2, FOT1_resp, FOT2_resp,  clte_fo1_resp, clte_fo2_resp, id_tipo_fo, str_const_status, Problematica, SubAnillo_Fi, PES, Atenuacion_Trab, Atenuacion_Resp, Longitud_Trab, Longitud_Resp, dt_ini_real, dt_remate_fo, str_sup_cons, str_const_status, dt_ins_col, dt_entrega_gestion_col, dt_integracion_colectora, dt_enlace_adva_colectora, dt_inst_equipo_acceso, dt_entrega_equipo_acceso, dt_gestion_equipo_acceso, dt_instalacion, dt_alimen_entrega, dt_inst_eq_acceso, dt_entraga_eq_acceso, dt_gestion_eq_acceso, const_rech, dt_rechazado, idcat_motvo_rch_fo, folio_gestion_nx, folio_gestion_cns, str_pend_clte_const FROM tb_eq_construcion WHERE referencia = '".$referencia."' and id_tramos = '".$id_tramos."'";
//echo $SQL."<br />";
	...
	$FOT1_resp=  $RS_3->fields(28);
	$FOT2_resp=  $RS_3->fields(29);
	$clte_fo1_resp=  $RS_3->fields(30);
	$clte_fo2_resp=  $RS_3->fields(31);
	$id_tipo_fo=  $RS_3->fields(32);
	$str_const_status=  $RS_3->fields(33);
	$Problematica=  $RS_3->fields(34);
	$SubAnillo_Fi=  $RS_3->fields(35);
	$PES=  $RS_3->fields(36);
	$Atenuacion_Trab= $RS_3->fields(37);
	$Atenuacion_Resp= $RS_3->fields(38);
	$Longitud_Trab= $RS_3->fields(39);
	$Longitud_Resp= $RS_3->fields(40);
	$dt_ini_real= $RS_3->fields(41);
	$dt_remate_fo= $RS_3->fields(42);
	$str_sup_cons= $RS_3->fields(43);
/////////INICIA CAMPOS DEL MOD CONSTRUCCION///////////////////
	$str_const_status=  $RS_3->fields(44);
	$dt_ins_col=  $RS_3->fields(45);
	$dt_entrega_gestion_col=  $RS_3->fields(46);
	$dt_integracion_colectora=  $RS_3->fields(47);
	$dt_enlace_adva_colectora=  $RS_3->fields(48);
	$dt_inst_equipo_acceso=  $RS_3->fields(49);
	$dt_entrega_equipo_acceso=  $RS_3->fields(50);
	$dt_gestion_equipo_acceso=  $RS_3->fields(51);
	$dt_instalacion=  $RS_3->fields(52);
	$dt_alimen_entrega=  $RS_3->fields(53);
	$dt_inst_eq_acceso=  $RS_3->fields(54);
	$dt_entraga_eq_acceso=  $RS_3->fields(55);
	$dt_gestion_eq_acceso=  $RS_3->fields(56);
	$const_rech=  $RS_3->fields(57);
	$dt_rechazado=  $RS_3->fields(58);
	$idcat_motvo_rch_fo=  $RS_3->fields(59);
	$folio_gestion_nx=  $RS_3->fields(60);
	$folio_gestion_cns=  $RS_3->fields(61);
	$str_pend_clte_const=  $RS_3->fields(61);
*/
}
...
/////////////////////FIN JSON///////////////////////////////////////////		
	...
	//			timePicker: true,
			...
			var F_Meta_Term_FO = new Picker.Date($$('#f_REF'), {
				pickerClass: 'datepicker_vista', 
	//			timePicker: true,
				format: '%Y-%m-%d',
				positionOffset: {x: 5, y: 0},
			...
			var F_Meta_Term_FO = new Picker.Date($$('#F_ini'), {
				pickerClass: 'datepicker_vista', 
	//			timePicker: true,
				format: '%Y-%m-%d',
				positionOffset: {x: 5, y: 0},
			...
			var F_Meta_Term_FO = new Picker.Date($$('#F_term'), {
				pickerClass: 'datepicker_vista', 
	//			timePicker: true,
				format: '%Y-%m-%d',
				positionOffset: {x: 5, y: 0},
...
function guarda_proy_eqp(e)
{
	...
	var Observaciones_Eq = $('Observaciones_Eq').value;
