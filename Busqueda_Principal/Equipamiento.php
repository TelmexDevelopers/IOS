...
header('Pragma: no-cache');
	...
	//require("../includes/header_equipamiento.php");
...
-->
	...
	var URL = 'reporte_equipamiento.php?'+datos;
	//alert(URL);
	window.location = URL;
	 }
	...
	var myHTMLRequest = new Request.HTML({
		url: 'equipamiento_paginacion.php',
		onRequest : function (){
...
//		 	alert('Referencia Correcta'); 
	...
	light = new LightFace.IFrame
					(
		{
				height:500, 
				width:1000,
				url: '../CSS3Accordion/acordion_equipamiento.php?referencia='+referencia+"&ser_n="+ser_n,
