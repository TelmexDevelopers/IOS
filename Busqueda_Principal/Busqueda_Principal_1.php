                ...
                <tr>
                	<td valign="top" align="left">
                    	<table width="475" border="0" class="Texto_Mediano_Gris">
                           ...
                           <tr>
                              <td>Cliente:</td>
                              <td><?php echo ImprimeCombo(14,"Elige una opcion"); ?></td>
                          </tr>
                             ...
                             <tr>
                                <td colspan="2"><input type="text" name="direccion"  id="direccion" class="validation-passed Busqueda_direccion"/><div id="direccion_text"></div></td>
                            </tr>
                        </table>
                    </td>
 <?php // }?>                    
...
?>
 ...
 <?php // }?>
                      align="center">
                      <input name="enviar"  type="button" id="enviar" value="Buscar" class="button1"/></td>
