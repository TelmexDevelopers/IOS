...
if (isset($_GET['referencia']) && isset($_GET['id_tramos']));
{
	$SQL_em = "SELECT emision_os FROM tb_seg_serv WHERE referencia = '".$referencia."' LIMIT 1";
//echo $SQL."<br />";
	$RS_em = TraeRecordset($SQL_em);
	if (!$RS_em) die('Error en DB0!');
	
	$fecha_emision = $RS_em->fields(0);
...
//{
	...
	//////////INICIA CAMPOS DE PROYECTO EQUIPO///////////////
		...
		$id_requiere_trbj= $RS_2->fields(55);
//	}
}
//if ($_SESSION["id_Area_Responsable"] == 21)
//{
	$SQL_3 = "SELECT id_requerimiento, id_edo_acometida, dt_PROGRAMADA, id_supervisor_fo, id_resp_sucope, id_resp_ipr, dt_solicitud_fo, str_planificador, dt_sol_planificacion, dt_rec_planificacion, dt_sol_permiso_ssp, dt_rec_permiso, dt_entrega_esp_fo, dt_ok_adecuaciones, delegacion, dt_elab_ot, dt_Entr_ot, str_recibe_OT, PEP_09, str_ped45, id_problematica, id_constructor, dt_proyecto_Ok, id_cancel, FOt1, FOt2, clte_fo1, clte_fo2, id_tipo, FOT1_resp, FOT2_resp,  clte_fo1_resp, clte_fo2_resp, id_tipo_fo, id_FO_Const_Estatus, id_problem_cons, SubAnillo_Fi, PES, Atenuacion_Trab, Atenuacion_Resp, Longitud_Trab, Longitud_Resp, dt_ini_real, dt_remate_fo, dt_entrega_fo, id_sup_const, id_cons_estatus, dt_ins_col, dt_entrega_gestion_col, dt_integracion_colectora, dt_enlace_adva_colectora, dt_inst_equipo_acceso, dt_entrega_equipo_acceso, dt_gestion_equipo_acceso, dt_instalacion, dt_alimen_entrega, dt_inst_eq_acceso, dt_entraga_eq_acceso, dt_gestion_eq_acceso, const_rech, dt_rechazado, idcat_motvo_rch_fo, folio_gestion_nx, folio_gestion_cns, str_pend_clte_const, str_anillo_rof FROM tb_eq_construcion WHERE referencia = '".$referencia."' and id_tramos = '".$id_tramos."'";
//echo $SQL."<br />";
	$RS_3 = TraeRecordset($SQL_3);
	if (!$RS_3) die('Error en DB125!');
	
	$num_registros_3 = $RS_3->RecordCount();
	if ($num_registros_3 > 0)
	{
		...
		$supervisor_construccion= $RS_3->fields(45);
...
//	if (!$RS_10) die('Error en DB236!');
//	
//	$num_registros_10 = $RS_10->RecordCount();
//	if ($num_registros_10 > 0)
//	{
...
LEFT JOIN cat_FO_Const_Estatus f ON b.id_FO_Const_Estatus = f.id_FO_Const_Estatus WHERE a.referencia = '".$referencia."' and a.id_tramos = '".$id_tramos."'";
	...
	$num_registros_4 = $RS_4->RecordCount();
	if ($num_registros_4 > 0)
	{
...
<script type="text/javascript" src="../arian-mootools-datepicker-2.2.0-0-ga1c7b2e/arian-mootools-datepicker-a1c7b2e/Source/Locale.es-ES-DatePicker.js"></script>
    <script type="text/javascript" src="../arian-mootools-datepicker-2.2.0-0-ga1c7b2e/arian-mootools-datepicker-a1c7b2e/Source/Picker.js"></script>
    <script type="text/javascript" src="../arian-mootools-datepicker-2.2.0-0-ga1c7b2e/arian-mootools-datepicker-a1c7b2e/Source/Picker.Attach.js"></script>
    <script type="text/javascript" src="../arian-mootools-datepicker-2.2.0-0-ga1c7b2e/arian-mootools-datepicker-a1c7b2e/Source/Picker.Date.js"></script>
    <link rel="stylesheet" type="text/css" href="../arian-mootools-datepicker-2.2.0-0-ga1c7b2e/arian-mootools-datepicker-a1c7b2e/Source/datepicker_dashboard/datepicker_dashboard.css"/>
...
<!--	<script type="text/javascript" src="../scripts_datepicker/datepicker/Source/Locale.es-ES-DatePicker.js"></script>
    ...
    <link rel="stylesheet" type="text/css" href="../scripts_datepicker/datepicker/Source/datepicker_dashboard/datepicker_dashboard.css"/>-->
...
<?php if ($_SESSION["id_Area_Responsable"] == 21) { // Const FO ?>
...
<?php if ($_SESSION["id_Area_Responsable"] == 5) { // Eq FO?>
	<?php if ($dt_fecha_prog == "") { ?>
...
<?php if ($_SESSION["id_Area_Responsable"] == 21) { // Const FO ?>
	<?php if ($dt_PROGRAMADA == "") { ?>
			var dt_PROGRAMADA = new Picker.Date($$('#dt_PROGRAMADA'), {
				pickerClass: 'datepicker_dashboard', 
	//			timePicker: true,
				format: '%Y-%m-%d',
				positionOffset: {x: 5, y: 0},
	...
	<?php } ?>
	<?php if ($dt_solicitud_fo == "") { ?>
			var dt_solicitud_fo = new Picker.Date($$('#dt_solicitud_fo'), {
				pickerClass: 'datepicker_dashboard', 
	//			timePicker: true,
				format: '%Y-%m-%d',
				positionOffset: {x: 5, y: 0},
	...
	<?php } ?>
	<?php if ($dt_sol_planificacion == "") { ?>
			var dt_sol_planificacion = new Picker.Date($$('#dt_sol_planificacion'), {
				pickerClass: 'datepicker_dashboard', 
	//			timePicker: true,
				format: '%Y-%m-%d',
				positionOffset: {x: 5, y: 0},
	...
	<?php } ?>
	<?php if ($dt_rec_planificacion == "") { ?>
			var dt_rec_planificacion = new Picker.Date($$('#dt_rec_planificacion'), {
				pickerClass: 'datepicker_dashboard', 
	//			timePicker: true,
				format: '%Y-%m-%d',
				positionOffset: {x: 5, y: 0},
	...
	<?php } ?>
	<?php if ($dt_sol_permiso_ssp == "") { ?>
			var dt_sol_permiso_ssp = new Picker.Date($$('#dt_sol_permiso_ssp'), {
				pickerClass: 'datepicker_dashboard', 
	//			timePicker: true,
				format: '%Y-%m-%d',
				positionOffset: {x: 5, y: 0},
	...
	<?php } ?>
	<?php if ($dt_rec_permiso == "") { ?>
			var dt_rec_permiso = new Picker.Date($$('#dt_rec_permiso'), {
				pickerClass: 'datepicker_dashboard', 
	//			timePicker: true,
				format: '%Y-%m-%d',
				positionOffset: {x: 5, y: 0},
	...
	<?php } ?>
	<?php if ($dt_entrega_esp_fo == "") { ?>
			var dt_entrega_esp_fo = new Picker.Date($$('#dt_entrega_esp_fo'), {
				pickerClass: 'datepicker_dashboard', 
	//			timePicker: true,
				format: '%Y-%m-%d',
				positionOffset: {x: 5, y: 0},
	...
	<?php } ?>
	<?php if ($dt_ok_adecuaciones == "") { ?>
			var dt_ok_adecuaciones = new Picker.Date($$('#dt_ok_adecuaciones'), {
				pickerClass: 'datepicker_dashboard', 
	//			timePicker: true,
				format: '%Y-%m-%d',
				positionOffset: {x: 5, y: 0},
	...
	<?php } ?>
	<?php if ($dt_elab_ot == "") { ?>
			var dt_elab_ot = new Picker.Date($$('#dt_elab_ot'), {
				pickerClass: 'datepicker_dashboard', 
	//			timePicker: true,
				format: '%Y-%m-%d',
				positionOffset: {x: 5, y: 0},
	...
	<?php } ?>
	<?php if ($dt_Entr_ot == "") { ?>
			var dt_Entr_ot = new Picker.Date($$('#dt_Entr_ot'), {
				pickerClass: 'datepicker_dashboard', 
	//			timePicker: true,
				format: '%Y-%m-%d',
				positionOffset: {x: 5, y: 0},
	...
	<?php } ?>
	<?php if ($dt_proyecto_Ok == "") { ?>
			var dt_proyecto_Ok = new Picker.Date($$('#dt_proyecto_Ok'), {
				pickerClass: 'datepicker_dashboard', 
	//			timePicker: true,
				format: '%Y-%m-%d',
				positionOffset: {x: 5, y: 0},
	...
	<?php } ?>
	<?php if ($dt_ini_real == "") { ?>
			var dt_ini_real = new Picker.Date($$('#dt_ini_real'), {
				pickerClass: 'datepicker_dashboard', 
	//			timePicker: true,
				format: '%Y-%m-%d',
				positionOffset: {x: 5, y: 0},
	...
	<?php } ?>
	<?php if ($dt_remate_fo == "") { ?>
			var dt_remate_fo = new Picker.Date($$('#dt_remate_fo'), {
				pickerClass: 'datepicker_dashboard', 
	//			timePicker: true,
				format: '%Y-%m-%d',
				positionOffset: {x: 5, y: 0},
	...
	<?php } ?>
	<?php if ($dt_entrega_fo == "") { ?>
			var dt_entrega_fo = new Picker.Date($$('#dt_entrega_fo'), {
				pickerClass: 'datepicker_dashboard', 
	//			timePicker: true,
				format: '%Y-%m-%d',
				positionOffset: {x: 5, y: 0},
	...
	<?php } ?>
	<?php if ($dt_ins_col == "") { ?>
			var dt_ins_col = new Picker.Date($$('#dt_ins_col'), {
				pickerClass: 'datepicker_dashboard', 
	//			timePicker: true,
				format: '%Y-%m-%d',
				positionOffset: {x: 5, y: 0},
	...
	<?php } ?>
	<?php if ($dt_entrega_gestion_col == "") { ?>
			var dt_entrega_gestion_col = new Picker.Date($$('#dt_entrega_gestion_col'), {
				pickerClass: 'datepicker_dashboard', 
	//			timePicker: true,
				format: '%Y-%m-%d',
				positionOffset: {x: 5, y: 0},
	...
	<?php } ?>
	<?php if ($dt_integracion_colectora == "") { ?>
			var dt_integracion_colectora = new Picker.Date($$('#dt_integracion_colectora'), {
				pickerClass: 'datepicker_dashboard', 
	//			timePicker: true,
				format: '%Y-%m-%d',
				positionOffset: {x: 5, y: 0},
	...
	<?php } ?>
	<?php if ($dt_enlace_adva_colectora == "") { ?>
			var dt_enlace_adva_colectora = new Picker.Date($$('#dt_enlace_adva_colectora'), {
				pickerClass: 'datepicker_dashboard', 
	//			timePicker: true,
				format: '%Y-%m-%d',
				positionOffset: {x: 5, y: 0},
	...
	<?php } ?>
	<?php if ($dt_inst_equipo_acceso == "") { ?>
			var dt_inst_equipo_acceso = new Picker.Date($$('#dt_inst_equipo_acceso'), {
				pickerClass: 'datepicker_dashboard', 
	//			timePicker: true,
				format: '%Y-%m-%d',
				positionOffset: {x: 5, y: 0},
	...
	<?php } ?>
	<?php if ($dt_entrega_equipo_acceso == "") { ?>
			var dt_entrega_equipo_acceso = new Picker.Date($$('#dt_entrega_equipo_acceso'), {
				pickerClass: 'datepicker_dashboard', 
	//			timePicker: true,
				format: '%Y-%m-%d',
				positionOffset: {x: 5, y: 0},
	...
	<?php } ?>
	<?php if ($dt_gestion_equipo_acceso == "") { ?>
			var dt_gestion_equipo_acceso = new Picker.Date($$('#dt_gestion_equipo_acceso'), {
				pickerClass: 'datepicker_dashboard', 
	//			timePicker: true,
				format: '%Y-%m-%d',
				positionOffset: {x: 5, y: 0},
	...
	<?php } ?>
	<?php if ($dt_instalacion == "") { ?>
			var dt_instalacion = new Picker.Date($$('#dt_instalacion'), {
				pickerClass: 'datepicker_dashboard', 
	//			timePicker: true,
				format: '%Y-%m-%d',
				positionOffset: {x: 5, y: 0},
	...
	<?php } ?>
	<?php if ($dt_alimen_entrega == "") { ?>
			var dt_alimen_entrega = new Picker.Date($$('#dt_alimen_entrega'), {
				pickerClass: 'datepicker_dashboard', 
	//			timePicker: true,
				format: '%Y-%m-%d',
				positionOffset: {x: 5, y: 0},
	...
	<?php } ?>
	<?php if ($dt_inst_eq_acceso == "") { ?>
			var dt_inst_eq_acceso = new Picker.Date($$('#dt_inst_eq_acceso'), {
				pickerClass: 'datepicker_dashboard', 
	//			timePicker: true,
				format: '%Y-%m-%d',
				positionOffset: {x: 5, y: 0},
	...
	<?php } ?>
	<?php if ($dt_entraga_eq_acceso == "") { ?>
			var dt_entraga_eq_acceso = new Picker.Date($$('#dt_entraga_eq_acceso'), {
				pickerClass: 'datepicker_dashboard', 
	//			timePicker: true,
				format: '%Y-%m-%d',
				positionOffset: {x: 5, y: 0},
	...
	<?php } ?>
	<?php if ($dt_gestion_eq_acceso == "") { ?>
			var dt_gestion_eq_acceso = new Picker.Date($$('#dt_gestion_eq_acceso'), {
				pickerClass: 'datepicker_dashboard', 
	//			timePicker: true,
				format: '%Y-%m-%d',
				positionOffset: {x: 5, y: 0},
	...
	<?php } ?>
	<?php if ($dt_rechazado == "") { ?>
			var dt_rechazado = new Picker.Date($$('#dt_rechazado'), {
				pickerClass: 'datepicker_dashboard', 
	//			timePicker: true,
				format: '%Y-%m-%d',
				positionOffset: {x: 5, y: 0},
	...
	<?php } ?>
	<?php if ($F_ini == "") { ?>
			var F_ini = new Picker.Date($$('#F_ini'), {
				pickerClass: 'datepicker_dashboard', 
	//			timePicker: true,
				format: '%Y-%m-%d',
				positionOffset: {x: 5, y: 0},
	...
	<?php } ?>
	<?php if ($F_term == "") { ?>
			var F_term = new Picker.Date($$('#F_term'), {
				pickerClass: 'datepicker_dashboard', 
	//			timePicker: true,
				format: '%Y-%m-%d',
				positionOffset: {x: 5, y: 0},
...
//			});
	...
	<?php } ?>
<?php if ($_SESSION["id_Area_Responsable"] == 5) { // Equipo FO ?>	
...
<?php if ($_SESSION["id_Area_Responsable"] == 5) { // Equipamiento FO ?>
...
function guarda_proye_fo(e)
{
	...
	var id_constructor = $('constructor').value;
	...
	var	id_sup_const = $('supervisor_construccion').value;
...
//	alert (datos);
		...
		onSuccess : function(tree, elements, html)	{
			...
			var url_ot = 'http://10.94.130.36/iosphp/TELMEX_IOS/Busqueda_Principal/print_formato_ot_fo.php';
...
<body>
 <table width="100" border="0" class="Texto_Mediano_Negro">
  <tr>
    ...
    <td><input type="text" name="direccion" id="direccion" class="combos_4" value="<?php echo htmlentities($direccion); ?>" /></td>
  </tr>
  <tr>
...
<!-- INICIA PRIMER TAB SISA -->    
  ...
  <tr>
    <td>Puntas:</td>
    <td><input type="text" align="center" name="tra_punta" id="tra_punta" class="combos_3" value="<?php echo $tra_punta; ?>" /></td>
    <td>F Tramo Afe</td>
  ...
  <tr>
    ...
    <td rowspan="2"><textarea name="direccion" id="direccion" cols="20" rows="4" readonly="readonly"><?php echo htmlentities ($direccion,ENT_QUOTES); ?></textarea></td>
    <td>Due Date:</td>
  ...
  <tr>
    <td>&nbsp;</td>
    <td>Obs_tramo:</td>
    <td colspan="5"><textarea name="tra_obser" id="tra_obser" cols="50" rows="2" readonly="readonly"><?php echo $tra_obser; ?></textarea>
   </td>
  </tr>
	</table>
		</fieldset>
  ...
  <tr>
    ...
    <td>F_OK_Ing-Eqp:</td>
    <td><input type="text" name="dt_ok_ing_eq" id="dt_ok_ing_eq" class="combo_red" value="<?php echo $dt_ok_ing_eq; ?>" />
    </td>
  </tr>
  <tr>
    <td>Central:</td>
  ...
  <tr>
    ...
    <td>Observaciones:</td>
    <td><textarea name="obs_tramo" cols="32" rows="1" readonly="readonly">&nbsp;</textarea></td>
  </tr>
  <tr>
    <td>Fecha_prog:</td>
...
<fieldset>
 ...
 <td height="183" colspan="4">
  ...
  <tr>
    ...
    <td width="143">
<?php if ($_SESSION["id_Area_Responsable"] == 5) { // Equipo FO ?>
    <input name="guarda_eqpo" type="button" id="guarda_eqpo" value="Guardar" />
<?php } ?>	
	</td>
  </tr>
...
<td width="610"><fieldset><legend></legend>
 ...
 <legend><strong>Proyectos</strong></legend>
  ...
  <tr>
      ...
      <td>Constructor</td>
      <td><?php echo ImprimeCombo(36,$constructor);?></td>
  </tr> 
  <tr>
      <td>FO Proy ES</td>
...
<td colspan="4">
    ...
    <tr>
        <td>Ctrl FO</td>
        <td><input type="text" name="FOt1" id="FOt1" class="combo_green_ch" value="<?php echo $FOt1; ?>" /></td>
        <td><input type="text" name="FOt2" id="FOt2" class="combo_green_ch" value="<?php echo $FOt2; ?>" /></td>
        <td>Clte FO</td>
        <td><input type="text" name="clte_fo1" id="clte_fo1" class="combo_green_ch" value="<?php echo $clte_fo1; ?>" /></td>
        <td><input type="text" name="clte_fo2" id="clte_fo2" class="combo_green_ch" value="<?php echo $clte_fo2; ?>" /></td>
        <td>Tipo</td>
        <td><?php echo ImprimeCombo(34,$id_tipo);?></td>
	<tr>
</table>
      ...
      <table width="600" border="0">
          <tr>
              <td>Ctrl FO</td>
              <td><input type="text" name="FOT1_resp" id="FOT1_resp" class="combo_green_ch" value="<?php echo $FOT1_resp; ?>" /></td>
              <td><input type="text" name="FOT2_resp" id="FOT2_resp" class="combo_green_ch" value="<?php echo $FOT2_resp; ?>" /></td>
              <td>Clte FO</td>
              <td><input type="text" name="clte_fo1_resp" id="clte_fo1_resp" class="combo_green_ch" value="<?php echo $clte_fo1_resp; ?>" /></td>
              <td><input type="text" name="clte_fo2_resp" id="clte_fo2_resp" class="combo_green_ch" value="<?php echo $clte_fo2_resp; ?>" /></td>
              <td width="50"><!--<input type="hidden" name="id_tipo_fo_hidden" class="combos_3" />--></td>
              <td width="150"><!--<input type="hidden" name="id_tipo_fo_hidden" class="combos_3" />--></td>
          <tr>
      </table>           
           </td>
           </tr>
   ...
   <tr>
      <td>Anillo ROF</td>
      <td><input type="text" name="str_anillo_rof" id="str_anillo_rof" class="combo_green" value="<?php echo $str_anillo_rof; ?>"  /></td>
      <td>Sup cons</td>
      <td><?php echo ImprimeCombo(35,$supervisor_construccion);?></td>
  </tr>
   <tr>
      <td>SubAnillo Fi</td>
      <td><input type="text" name="SubAnillo_Fi" id="SubAnillo_Fi" class="combo_green" value="<?php echo $SubAnillo_Fi; ?>" /></td>
      <td>F entrega FO</td>
   ...
   <tr>
      ...
      <td colspan="2" align="center"><?php if ($_SESSION["id_Area_Responsable"] == 21) { // Const FO ?>
<input name="guarda_proy_fo" type="button" id="guarda_proy_fo" value="Guardar" /><?php } ?>  </td>
...
<?php } ?>  
<!-- FIN DEL TERCER TAB PROYECTO DE FIBRA OPTICA --> 
<?php if ($_SESSION["id_Area_Responsable"] == 5) { // Const FO ?>
...
<table width="100" border="0" class="Texto_Mediano_Negro">
  <tr>
    ...
    <table width="900" border="0" class="Texto_Mediano_Negro">
      <tr>
        <td>Requerimiento</td>
        <td><input type="text" name="str__requerimiento" id="str__requerimiento" class="combos_3" value="<?php echo $str__requerimiento; ?>" /></td>
        <td>Resp. Sucope</td>
        <td><input type="text" name="str_resp_sucope" id="str_resp_sucope" class="combos_3" value="<?php echo $str_resp_sucope; ?>" /></td>
        <td>Resp. IPR</td>
        <td><input type="text" name="str_resp_ipr" id="str_resp_ipr" class="combos_3" value="<?php echo $str_resp_ipr; ?>" /></td>
      </tr>
      <tr>
        <td>Tipo Proyecto</td>
          ...
          <tr>
            <td colspan="10"><table width="858" border="0" class="Texto_Mediano_Negro">
              <tr>
                ...
                <td width="164" align="center">Nombre Central</td>
    ...
    <tr><!--inicia tercer fila-->
        ...
        <table width="987" border="0" class="Texto_Mediano_Negro">
          ...
          <tr>
            ...
            <td>&nbsp;</td>
            <td align="center"><?php if ($_SESSION["id_Area_Responsable"] == 21) { // Const FO ?><input name="guarda_construccion" type="button" id="guarda_construccion" value="Guardar" /><?php } ?></td>
          </tr>
        </table></td><!--termina3.1-->
...
<div class="content"><div>
		...
		<table width="950" border="0" class="Texto_Mediano_Negro">
          <tr>
            ...
            <table width="100%" border="0">
                 <tr>
                   ...
                   <td>Asignado a:</td>
                   <td ><?php echo imprimecombo(4,"");?>
                   
                   <input type="hidden" name="id_tramos" id="id_tramos" value="<?php echo $id_tramos; ?>" />
                   <input type="hidden" name="id_Usuario_Elab" id="id_Usuario_Elab" value="<?php echo $_SESSION["id_Usuario"]; ?>" />
                   <input type="hidden" name="id_Area_Resp" id="id_Area_Resp" value="<?php echo $_SESSION["id_Area_Responsable"]; ?>" />
                   <input type="hidden" name="id_Tipo_Usuario" id="id_Tipo_Usuario" value="<?php echo $_SESSION["id_Tipo_Usuario"]; ?>" />
                   </td>
                 </tr>
                 <tr>
                   <td>Usuario:</td>
                   <td><input type="text" name="str_usuario_ot" id="str_usuario_ot" value="<?php echo $usuario; ?>" /></td>
                   <td>Raz&oacute;n Social:</td>
                   <td><input type="text" name="str_usuario_puntas_ot" id="str_usuario_puntas_ot" value="<?php echo $usuario_puntas; ?>" /></td>
                   <td>Direcci&oacute;n:</td>
                   <td><input type="text" name="str_direccion_ot" id="str_direccion_ot" value="<?php echo htmlentities($direccion); ?>" /></td>
                 </tr>
                 <tr>
                 ...
                 <tr>
                   ...
                   <td><input name="str_tipo_servicio" id ="str_tipo_servicio" type="text" value="<?php echo $str_tipo_servicio; ?>" size="30" /></td>
                 </tr>
                 <tr>
                 ...
                 <tr>
                   ...
                   <td><input type="text" name="f_REF" id="f_REF" value="<?php echo $fecha_emision; ?>" /></td>
                   <td>Fecha Termino:</td>
          ...
          <tr>
        	 <td align="left">Trabajos a realizar:</td>
             <td><textarea name="trabajos_realizar" id="trabajos_realizar" cols="60" rows="5" ><?php echo $trabajos_realizar; ?></textarea></td>
          </tr>
          <tr>
...
<tr>
    ...
    <td width="165"><?php if ($_SESSION["id_Area_Responsable"] == 21) { // Const FO ?><input type="button" name="save_ot" id="save_ot"  value="Imprimir y Guardar" /><?php } ?>
    </td>
    <td width="87">&nbsp;</td>
