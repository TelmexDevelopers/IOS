...
/*********************************************FUNCION PARA ENLACE****************************************/
	...
	window.addEvent('domready', function() {
		$('Supervisores_Analisis').addEvent('change',pedirDatos)
    });
	
//function LimpiarSelect(Sup_Analisis) {
//    var Control = document.getElementById(Sup_Analisis);
...
//	alert(coment);
var datos = "Supervisores_Analisis="+Supervisores_Analisis;
...
//alert(datos);
			...
			$('Supervisores_Analisis').set('value',json.id_Usuario);
			//$('str_Nombre_ipe').set('value',json.str_Nombre_ipe);
...
//function CreaSelect(Sup_Analisis) {
//    var selected = document.getElementById(Sup_Analisis);
...
<?php if ($id_Area_Responsable == 1 || $id_Area_Responsable == 2 || $id_Area_Responsable == 3 ) { ?>
                            ...
                            <tr>
                                <td>IPE Analisis:</td>
                                <td><?php echo ImprimeCombo(11,"id_Usuario"); ?></td>
                            <tr>
