...
?> 
  var Supervisores_Analisis= $('Supervisores_Analisis').value;
 //  var Supervisores_Documentacion= $('Supervisores_Documentacion').value;
  var ipe_analisis= $('ipe_analisis').value;
 //  var ipe_Documentacion= $('ipe_Documentacion').value;
<?php 		}
			if ($id_Area_Responsable == 4)
			{
?> 
   var subgerente_entrega= $('subgerente_entrega').value;
   var ipe_entrega= $('ipe_entrega').value;
   var Supervisores_Entrega= $('Supervisores_Entrega').value;
<?php		
			}
...
?>
	'Supervisores_Analisis='+Supervisores_Analisis+
	// '&Supervisores_Documentacion='+Supervisores_Documentacion+
	'&ipe_analisis='+ipe_analisis+
	// '&ipe_Documentacion='+ipe_Documentacion+
<?php
		  }
		  if ($id_Area_Responsable == 4)
		  {
?>		
	'&subgerente_entrega='+subgerente_entrega+
	'&ipe_entrega='+ipe_entrega+
	'&Supervisores_Entrega='+Supervisores_Entrega+
<?php
		  }
...
<?php
	  ...
	  {
?> 
		$('Supervisores_Entrega').addEvent('change', function(event) {
...
<?php }?>
	...
	function Combo_Encadenado(e){
			...
			switch (e.target.id)
			{
				case 'Supervisores_Entrega':
					var combo_ipes = 'ipe_entrega';
				break;
			...
			var id_Area_Responsable = <?php echo $id_Area_Responsable; ?>;
			var datos = 'id_usuario_Jefe_Inmediato='+id_combo+"&id_Area_Responsable="+id_Area_Responsable;
...
<?php   if ($id_Area_Responsable == 1 || $id_Area_Responsable == 2 || $id_Area_Responsable == 3 ) { ?>
                              ...
                              <tr>
                                ...
                                <td>
								<?php echo ImprimeCombo(10,""); ?></td>
                            </tr>
                            <tr>
                                <td>IPE Analisis:</td>
                                <td><?php  echo ImprimeCombo(11,"id_usuario_Jefe_Inmediato");  ?></td>
                            </tr>
                            <!--<tr>
                                <td>Supervisor Documentaci&oacute;n:</td>
                                <td><?php //echo ImprimeCombo(15,""); ?></td>
                            </tr>
                            <tr>
                                <td>IPE Documentaci&oacute;n:</td>
                                <td><?php //echo ImprimeCombo(16,""); ?></td>
							</tr>-->
<?php    }if ($id_Area_Responsable == 4)  { ?> 
                            <tr>
                                <td>Subgerente Entrega:</td>
...
<?php  }   ?>
                           <tr>
                                <td>Cliente:</td>
                                <td><?php echo ImprimeCombo(19,"Elige una opcion"); ?></td>
                            </tr>
                             <tr>
                                <td>Tipo de servicio:</td>
                                <td><?php echo ImprimeCombo(20,"Elige una opcion"); ?></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
								<td colspan="2">
                                <input type="text" size="55" name="direccion"  id="direccion" class="validation-passed Busqueda_direccion"/><div id="direccion_text"></div></td>
                               </tr>	 
                        </table>
                    </td>
 <?php  } ?>                     
                	<td valign="top" align="left">
                    	<table  width="475" border="0" class="Texto_Mediano_Gris">
                            ...
                            <tr>
                              <td>GOA:</td>
                              <td colspan="2"><?php echo ImprimeCombo(13,""); ?></td>
                            </tr>
                            <tr>
                              <td>CM:</td>
                              <td colspan="2"><?php echo ImprimeCombo(12,""); ?></td>
                            </tr>
                        </table>
                    </td>
                </tr>
