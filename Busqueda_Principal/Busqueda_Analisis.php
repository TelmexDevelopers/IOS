                ...
                <tr>
                	<td valign="top" align="left">
                    	<table width="475" border="0" class="Texto_Mediano_Gris">
                            <tr>
                                <td>Division:</td>
                                <td><select id="DD" name="DD" class="mootools combos_busqueda"><option value="">Elige una opcion</option><option value="metro">Metro</option></select></td>
                            </tr>
                            <tr>
                                <td>Entidad:</td>
