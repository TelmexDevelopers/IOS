 ...
 <style type="text/css">
  .filas_tabla_responsables
  {
	...
	<script type="text/javascript">
		...
		function crea_combo_ipe(fila,ipe)
		{
			var html = '<select name="referencia[][ipe'+ipe+']" id="ipe_'+fila+'" class="required combo"><option value="">Seleccione</option><?php echo opciones_usuarios(4, $id_Area_Responsable,''); ?></select>';
...
?>
			{// 3
				content: crea_combo_ipe(fila,<?php echo $x; ?>),
				properties: {
					align: 'center'
				}	
			},
...
<?php
	...
	{
?>
        <td><b>IPE An&aacute;lisis</b></td>
        <td><b>IPE Documentaci&oacute;n</b></td>
        <td><b>IPE Seguimiento</b></td>
<?php 
	} else { 
		switch ($id_Area_Responsable)
		{
			case 4:
				$txt_area_responsable = 'Entrega';
			break;
			case 5:
				$txt_area_responsable = 'Equipamiento';
			break;
		}
		echo '<td><b>IPE '.$txt_area_responsable.'</b></td>';
