...
//include('../../Busqueda_Principal/Libreria_OT_construccion.php');
...
<!-- FIN DEL CUARTO TAB CONSTRUCCION -->  
		...
		<table width="950" border="1" class="Texto_Mediano_Negro" rules="rows">
            ...
            <td colspan="6">
                       <table width="100%" border="0">
                         ...
                         <tr>
                           ...
                           <td><label for="n_accesso"></label>
                           <input type="text" name="n_accesso" id="n_accesso" /></td>
                           <td>Anillo:</td>
                           <td ><label for="anillo"></label>
                           <input type="text" name="anillo" id="anillo" /></td>
                           <td>Fibras signadas:</td>
                           <td><label for="f_asignadas"></label>
                           <input type="text" name="f_asignadas" id="f_asignadas" /></td>
                         </tr>
                         <tr>
                           <td>CLL:</td>
                           <td><label for="cll"></label>
                           <input type="text" name="cll" id="cll" /></td>
                           <td>Posicion del DBFO:</td>
                           <td><label for="P_DBFO"></label>
                           <input type="text" name="P_DBFO" id="P_DBFO" /></td>
                           <td>&nbsp;</td>
                           <td>&nbsp;</td>
                         </tr>
                         <tr>
                           <td width="149">Referencia SISA:</td>
                           <td width="181"><label for="REF"></label>
                             <input type="text" name="REF" id="REF" /></td>
                           <td width="169">Fecha Inicio:</td>
                           <td width="225"><label for="F_ini"></label>
                             <input type="text" name="F_ini" id="F_ini" /></td>
                           <td width="226">Elemento PEP De F.O:</td>
                           <td width="528"><label for="elemnt"></label>
                             <input type="text" name="elemnt" id="elemnt" /></td>
                         </tr>
                         <tr>
                           ...
                           <td><label for="REF"></label>
                             <input type="text" name="REF" id="REF" /></td>
                           <td>Fecha Termino:</td>
                           <td><label for="F_ini"></label>
                             <input type="text" name="F_ini" id="F_ini" /></td>
                           <td>Elemento PEP Canalizacion:</td>
                           <td><label for="elemnt"></label>
                             <input type="text" name="elemnt" id="elemnt" /></td>
                         </tr>
                   		</table>
            </td>
          ...
          <tr>
        	 <td align="center">Trabajos a realizaar:</td>
             <td colspan="5"><label for="trabajos a realizar"></label>
            <textarea name="trabajos a realizar" id="trabajos a realizar" cols="60" rows="5"></textarea></td>
          </tr>
          <tr>
          ...
          <tr>
             ...
             <td colspan="3" rowspan="2"><label for="trabajos a realizar"></label>
            <textarea name="trabajos a realizar" id="trabajos a realizar" cols="60" rows="5"></textarea></td>
             <td colspan="2" align="center">Tipo de Servicio:</td>
          </tr>
          <tr>
             <td colspan="2" align="center"><input name="amp_fib" id ="amp_fib" type="text" value="AMPLIACION DE FIBRA" SIZE="30" /></td>
          </tr>
          <tr>
            <td colspan="6">          
            <td>          
