...
window.addEvent('domready', function() {
	...
	function excel()
	{
	var combo1= $('cat_con_ot').value;
	var combo2= $('cat_area_responsable').value;
	var combo3= $('cat_combo_cm').value;
	var combo4= $('cat_combo_area_cm').value;
    var combo5= $('cat_Filial').value;
