...
if (isset($_GET['referencia']) && isset($_GET['ser_n']));
{
	$SQL = "SELECT referencia,
	 ...
	 ser_n,
	 clas_1
	 FROM vw_ios_reg_ale WHERE referencia = '".$referencia."' AND ser_n = '".$ser_n."'";
	//echo $SQL."<br />";
...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
	...
	{
	var datos_referencia = 'search_ref_ale.php?referencia=<?php echo $referencia; ?>&ser_n=<?php echo $ser_n_ok; ?>';
