...
<head>
    ...
    <script type="text/javascript">
        ...
        document.addEvent('domready', function() {
			...
			Locale.use('es-ES');
			new Date().format('db');
			var Fecha_prog = new Picker.Date(document.getElementsByName('dt_fecha_prog'), {
...
//	
//		
//	alert($$('#blur_text_SISA text.blur_text').lenght);
//
//
////	$$('#blur_text_SISA text.blur_text').addEvent('click',function {
...
<!-- INICIA PRIMER TAB SISA -->    
  ...
  <tr>
    <td>Fecha_prog:</td>
    <td><input type="text" name="dt_fecha_prog" id="dt_fecha_prog" class="combo_green" onblur="javascript:Envia_Datos();" /></td>
    <td>Vencido:</td>
  ...
  <tr>
    ...
    <td><input type="text" name="documento_pagina_web" id="documento_pagina_web" class="combos_3 blur_text" /></td>
    <td>Cancelado:</td>
    <td><input type="checkbox" name="Cancelado" value="33333" id="Cancelado" /></td>
