...
{
	$SQL = "SELECT id_tramos, referencia, ref_tramo, edo_tramo, coordinacion_abrev, fecha_afect, edo_serv, tipo_proy, DUE_DATE, tra_obser, tra_punta, SIGLAS_ios, area, central, division, usuario, usuario_puntas, direccion FROM vw_tramos_fo WHERE referencia = '".$referencia."' and id_tramos = '".$id_tramos."'";
//echo $SQL."<br />";
...
//	$SQL_3 = "SELECT id_requerimiento, id_resp_sucope, id_resp_ipr, str_tipo_proy, dt_meta_term_const, id_edo_fo, id_atraso, str_planificador, dt_sol_planificacion, dt_rch, dt_def_trayectoria, dt_ok_acometida, str_ot_fo, str_pep, dt_elab_ot, str_ped45, dt_Entr_ot, dt_ini_real, str_recibe_OT, dt_term_real, dt_PROGRAMADA, str_Constructor, id_res_super, str_problematica, ctrl_fo, str_anillo_rof, clte_fo, str_tipo, str_const_status, dt_ins_col, dt_entrega_gestion_col, dt_integracion_colectora, dt_enlace_adva_colectora, dt_inst_equipo_acceso, dt_entrega_equipo_acceso, dt_gestion_equipo_acceso, dt_instalacion, dt_alimen_entrega, dt_inst_eq_acceso, dt_entraga_eq_acceso, dt_gestion_eq_acceso, const_rech, dt_rechazado, idcat_motvo_rch_fo, folio_gestion_nx, folio_gestion_cns, str_pend_clte_const FROM tb_eq_construcion WHERE referencia = '".$referencia."' and id_tramos = '".$id_tramos."'";
////echo $SQL."<br />";
...
//	$id_resp_sucope= $RS_3->fields(1);
//	$id_resp_ipr=  $RS_3->fields(2);
//	$str_tipo_proy=  $RS_3->fields(3);
//	$dt_meta_term_const=  $RS_3->fields(4);
//	$id_edo_fo=  $RS_3->fields(5);
//	$id_atraso=  $RS_3->fields(6);
//	$str_planificador=  $RS_3->fields(7);
//	$dt_sol_planificacion=  $RS_3->fields(8);
//	$dt_rch=  $RS_3->fields(9);
//	$dt_def_trayectoria=  $RS_3->fields(10);
//	$dt_ok_acometida=  $RS_3->fields(11);
//	$str_ot_fo=  $RS_3->fields(12);
//	$str_pep=  $RS_3->fields(13);
//	$dt_elab_ot=  $RS_3->fields(14);
//	$str_ped45=  $RS_3->fields(15);
//	$dt_Entr_ot=  $RS_3->fields(16);
//	$dt_ini_real=  $RS_3->fields(17);
//	$str_recibe_OT=  $RS_3->fields(18);
//	$dt_term_real=  $RS_3->fields(19);
//	$dt_PROGRAMADA=  $RS_3->fields(20);
//	$str_Constructor=  $RS_3->fields(21);
//	$id_res_super=  $RS_3->fields(22);
//	$str_problematica=  $RS_3->fields(23);
//	$ctrl_fo=  $RS_3->fields(24);
//	$str_anillo_rof=  $RS_3->fields(25);
//	$clte_fo=  $RS_3->fields(26);
//	$str_tipo=  $RS_3->fields(27);
///////////INICIA CAMPOS DEL MOD CONSTRUCCION///////////////////
//	$str_const_status=  $RS_3->fields(28);
//	$dt_ins_col=  $RS_3->fields(29);
//	$dt_entrega_gestion_col=  $RS_3->fields(30);
//	$dt_integracion_colectora=  $RS_3->fields(31);
//	$dt_enlace_adva_colectora=  $RS_3->fields(32);
//	$dt_inst_equipo_acceso=  $RS_3->fields(33);
//	$dt_entrega_equipo_acceso=  $RS_3->fields(34);
//	$dt_gestion_equipo_acceso=  $RS_3->fields(35);
//	$dt_instalacion=  $RS_3->fields(36);
//	$dt_alimen_entrega=  $RS_3->fields(37);
//	$dt_inst_eq_acceso=  $RS_3->fields(38);
//	$dt_entraga_eq_acceso=  $RS_3->fields(39);
//	$dt_gestion_eq_acceso=  $RS_3->fields(40);
//	$const_rech=  $RS_3->fields(41);
//	$dt_rechazado=  $RS_3->fields(42);
//	$idcat_motvo_rch_fo=  $RS_3->fields(43);
//	$folio_gestion_nx=  $RS_3->fields(44);
//	$folio_gestion_cns=  $RS_3->fields(45);
//	$str_pend_clte_const=  $RS_3->fields(46);
...
//			});
	...
	//			timePicker: true,
			...
			var Fecha_Prog = new Picker.Date($$('#dt_entraga_eq_acceso'), {
				pickerClass: 'datepicker_vista', 
	//			timePicker: true,
				format: '%Y-%m-%d',
				positionOffset: {x: 5, y: 0},
...
function guarda_proye_fo(e)
{
	...
	var	str_const_status = $('str_const_status').value;
	var	Problematica = $('Problematica').value;
	...
	+"&str_const_status="+str_const_status
...
<fieldset>
 ...
 <td height="183" colspan="4">
  ...
  <tr>
    <td width="437"><p>
        <textarea name="Observaciones_Eq" id="Observaciones_Eq" cols="70" rows="5" tabindex="20" readonly="readonly"></textarea>
        </p></td>
    <td width="143"><input name="guarda_eqpo" type="button" id="guarda_eqpo" value="Guardar_2" /></td>
  </tr>
...
<td width="610"><fieldset><legend></legend>
  ...
  <table width="336" border="0" class="Texto_Mediano_Negro">
   ...
   <tr>
        ...
        <td><input type="text" name="dt_entrega_fo" id="dt_entrega_fo" class="combos_3" value="<?php echo $dt_entrega_fo ?>" /></td>
   </tr>
   <tr>
 ...
 <legend><strong>Proyectos</strong></legend>
  ...
  <tr>
        <td>&nbsp;</td>
        <td><div id="resultado_proyecto_fo" style="font-weight:bold;"></div></td>
        <td>&nbsp;</td>
        <td><input name="guarda_proy_fo" type="button" id="guarda_proy_fo" value="Guardar_5" /></td>
  </tr>     
  </table>
</fieldset>
    </td>
...
<td colspan="4">
    ...
    <tr>
        ...
        <td width="40">Tipo</td>
        <td width="155"><input type="text" name="id_tipo_fo" id="id_tipo_fo" class="combo_green" value="<?php echo $id_tipo_fo ?>" /></td>
	<tr>
</table>
      ...
      <td><input type="text" name="str_const_status" id="str_const_status" class="combo_green" value="<?php echo $str_const_status ?>" /></td>
      <td>F ini real</td>
      <td><input type="text" name="dt_ini_real" id="dt_ini_real" class="combo_green" value="<?php echo $dt_ini_real ?>" /></td>
  </tr>
   <tr>
      <td>Problematica</td>
      <td><input type="text" name="Problematica" id="Problematica" class="combo_green" value="<?php echo $Problematica ?>" /></td>
      <td>F remate fo</td>
   ...
   <tr>
      ...
      <td>F entrega fo</td>
      <td><input type="text" name="entrega_fo" id="entrega_fo" class="combo_pink"  /></td>
  </tr>
   <tr>
      <td>PES</td>
...
<table width="100" border="0" class="Texto_Mediano_Negro">
  ...
  <tr>
    ...
    <table width="600" border="0" class="Texto_Mediano_Negro">
      ...
      <tr>
        <td>&nbsp;</td>
        <td><!--<button id="abrir">Ingresar comentarios</button>-->&nbsp;</td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
      </tr>
    </table>
...
<!-- --- -- -- -- -- -- --Generacion de div para construccion-->
    <div class="content">
    MENSAJE DE PRUEBA
  ...
  <input name="referencia" type="hidden" id="referencia" value="<?php echo $referencia; ?>" /> 
    <table width="950" height="441" border="1"><!--inicio tabla principal-->
    ...
    <tr><!--inicio primera fila de tabla principal-->
        ...
        <table width="939" border="0" class="Texto_Mediano_Negro">
          <tr>
            <td colspan="10"><table width="927" border="0" class="Texto_Mediano_Negro">
              <tr>
              ...
              <tr>
                <td><input type="text" name="SIGLAS_ios2" id="SIGLAS_ios2" class="combo_pink_ch" value="<?php echo $SIGLAS_ios ?>" /></td>
                <td><input type="text" name="central2" id="central2" class="combos_3" value="<?php echo $central ?>" /></td>
                <td><input type="text" name="centro_manto2" id="centro_manto2" class="combo_pink"  /></td>
                <td><input type="text" name="jefe_manto2" id="jefe_manto2" class="combo_pink"  /></td>
                <td><input type="text" name="telefono_jefe2" id="telefono_jefe2" class="combo_pink"  /></td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                ...
                <td><input type="text" name="jefe_goa2" id="jefe_goa2" class="combos_3"  /></td>
                <td align="right">Telefono</td>
                <td><input type="text" name="tel_goa2" id="tel_goa2" class="combos_3"  /></td>
              </tr>
            </table></td>
          </tr>
          <tr>
            <td width="90">Const Status</td>
            <td width="111"><input type="text" name="str_const_status2" id="str_const_status2" class="combo_yellow" value="<?php echo $str_const_status ?>" /></td>
            <td width="153">F meta Term Const</td>
            <td width="120"><input type="text" name="Longitud2" id="Longitud2" class="combo_blue"  /></td>
            <td width="196">Pendiente por Clte Const</td>
            <td width="243"><input type="text" name="str_pend_clte_const2" id="str_pend_clte_const2" class="combos_3" value="<?php echo $str_pend_clte_const ?>" /></td>
          </tr>
   ...
   <!--inicia td 2.1--> <td colspan="6"><table width="550" border="0" class="Texto_Mediano_Negro">
     ...
     <tr>
       <td><input type="text" name="dt_ins_col2" id="dt_ins_col2" class="combos_3" value="<?php echo $dt_ins_col ?>" /></td>
       <td>&nbsp;</td>
       <td><input type="text" name="dt_inst_equipo_acceso2" id="dt_inst_equipo_acceso2" class="combos_3" value="<?php echo $dt_inst_equipo_acceso ?>" /></td>
     </tr>
     <tr>
     ...
     <tr>
       <td><input type="text" name="dt_entrega_gestion_col2" id="dt_entrega_gestion_col2" class="combos_3" value="<?php echo $dt_entrega_gestion_col ?>" /></td>
       <td>&nbsp;</td>
       <td><input type="text" name="dt_entrega_equipo_acceso2" id="dt_entrega_equipo_acceso2" class="combos_3" value="<?php echo $dt_entrega_equipo_acceso ?>" /></td>
     </tr>
     <tr>
     ...
     <tr>
       <td><input type="text" name="dt_integracion_colectora2" id="dt_integracion_colectora2" class="combos_3" value="<?php echo $dt_integracion_colectora ?>" /></td>
       <td>&nbsp;</td>
       <td><input type="text" name="dt_gestion_equipo_acceso2" id="dt_gestion_equipo_acceso2" class="combos_3" value="<?php echo $dt_gestion_equipo_acceso ?>" /></td>
     </tr>
     <tr>
     ...
     <tr>
       <td><input type="text" name="dt_enlace_adva_colectora2" id="dt_enlace_adva_colectora2" class="combos_3" value="<?php echo $dt_enlace_adva_colectora ?>" /></td>
       <td colspan="2"></td>
     </tr>
    ...
    <!--inicia td 2.2--><td colspan="4"><fieldset>
      ...
      <table width="280" border="0" class="Texto_Mediano_Negro">
        <tr>
          ...
          <td width="194"><input type="text" name="const_rech2" id="const_rech2" class="combo_pink_ch" value="<?php echo $const_rech ?>" /></td>
        </tr>
        <tr>
          <td>Fecha Rech</td>
          <td><input type="text" name="dt_rechazado2" id="dt_rechazado2" class="combos_3" value="<?php echo $dt_rechazado ?>" /></td>
        </tr>
        <tr>
          <td>Motivo</td>
      ...
      <table width="315" border ="0" class="Texto_Mediano_Negro">
        <tr>
          ...
          <td width="127"><input type="text" name="folio_gestion_nx2" id="folio_gestion_nx2" class="combos_3" value="<?php echo $folio_gestion_nx ?>" /></td>
        </tr>
        <tr>
          <td>Folio Gestion CNS-1</td>
          <td><input type="text" name="folio_gestion_cns2" id="folio_gestion_cns2" class="combos_3" value="<?php echo $folio_gestion_cns ?>" /></td>
        </tr>
        <tr>
          <td colspan="2"><div id="resultado_cons2" style="font-weight:bold;"></div></td>
    ...
    <td><input name="guarda_construccion" type="button" id="guarda_construccion" value="Guardar_4" /></td>-->
        ...
        <tr>
          <td colspan="2" align="center"><input name="guarda_construccion2" type="button" id="guarda_construccion2" value="Guardar_4" /></td>
        </tr>
      		</table >
      </td><!--termina 2.2-->
    ...
    <tr><!--inicia tercer fila-->
        ...
        <table width="987" border="0" class="Texto_Mediano_Negro">
          <tr>
            <td width="170"><input type="text" name="dt_instalacion2" id="dt_instalacion2" class="combos_3" value="<?php echo $dt_instalacion ?>" /></td>
            <td width="170">Instalaci&oacute;n</td>
            <td width="199"><input type="text" name="dt_entraga_eq_acceso2" id="dt_entraga_eq_acceso2" class="combos_3" value="<?php echo $dt_entraga_eq_acceso ?>" /></td>
            <td width="430">Entrega Eq. Acceso</td>
          </tr>
          <tr>
            <td><input type="text" name="dt_alimen_entrega2" id="dt_alimen_entrega2" class="combos_3" value="<?php echo $dt_alimen_entrega ?>" /></td>
            <td>Alimentaci&oacute;n Entrega</td>
            <td><input type="text" name="dt_gestion_eq_acceso2" id="dt_gestion_eq_acceso2" class="combos_3" value="<?php echo $dt_gestion_eq_acceso ?>" /></td>
            <td>Gestion Eq. Acceso(FRIDA/Gesti&oacute;n NX)</td>
          </tr>
          <tr>
            <td height="24"><input type="text" name="dt_inst_eq_acceso2" id="dt_inst_eq_acceso2" class="combos_3" value="<?php echo $dt_inst_eq_acceso ?>" /></td>
  ...
  <tr>
    ...
    <tr>
      ...
      <tr>
        ...
        <tr>
          <td width="90">Const Status</td>
          <td width="111"><input type="text" name="str_const_status" id="str_const_status" class="combo_yellow" value="<?php echo $str_const_status ?>" /></td>
          <td width="153">F meta Term Const</td>
...
<table width="315" border ="0" class="Texto_Mediano_Negro">
  ...
  <tr><td colspan="2"><div id="resultado_cons" style="font-weight:bold;"></div></td>
<!--    <td><div id="resultado_cons" style="font-weight:bold;"></div></td>
    <td><input name="guarda_construccion" type="button" id="guarda_construccion" value="Guardar_4" /></td>-->
    </tr>
    <tr><td colspan="2" align="center"><input name="guarda_construccion" type="button" id="guarda_construccion" value="Guardar_4" /></td></tr>
</table >
<!--<table width="290" border="0">
  <tr>
    <td colspan="2"><div id="resultado_cons" style="font-weight:bold;"></div></td>
    </tr>
  <tr>
    <td width="126">&nbsp;</td>
    <td width="156" align="center"><input name="guarda_construccion" type="button" id="guarda_construccion" value="Guardar_4" /></td>
  </tr>
</table>-->
</td>
        </tr>
 ...
 <table width="500" border="0" class="Texto_Mediano_Negro">
      <tr>
        <td><input type="text" name="dt_instalacion" id="dt_instalacion" class="combos_3" value="<?php echo $dt_instalacion ?>" /></td>
      ...
      <tr>
        <td><input type="text" name="dt_inst_eq_acceso" id="dt_inst_eq_acceso" class="combos_3" value="<?php echo $dt_inst_eq_acceso ?>" /></td>
        <td>Instalaci&oacute;n Eq. Acceso</td>
      </tr>
      <tr>
        <td><input type="text" name="dt_entraga_eq_acceso" id="dt_entraga_eq_acceso" class="combos_3" value="<?php echo $dt_entraga_eq_acceso ?>" /></td>
