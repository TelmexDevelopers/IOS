...
////////////////////////////////////////////////////////
////////////////////////////////////////////////////////	
	$SQL_2 = "SELECT id_tramos, id_analisa_ing_eq, dt_ok_ing_eq, id_proy_sisa, dt_fecha_prog, documento_pagina_web, id_proy_sisa, id_vencido, id_cancelado FROM tb_equip_fo WHERE referencia = '".$referencia."' and id_tramos = '".$id_tramos."'";
	//echo $SQL_2;
...
<!-- INICIA PRIMER TAB SISA -->    
  ...
  <tr>
    ...
    <td><textarea name="direccion" id="direccion" cols="20" rows="4"><?php echo htmlentities ($direccion,ENT_QUOTES); ?></textarea></td>
    <td>Due Date:</td>
