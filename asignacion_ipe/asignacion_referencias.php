...
include("../Busqueda_Principal/libreria.php");

$id_Tipo_Usuario = $_SESSION['1'];
$id_Area_Responsable = $_SESSION['1'];

//($_SESSION['id_Tipo_Usuario'] == 4 || $_SESSION['id_Tipo_Usuario'] == 5)
if ("") 
{
 ...
 <style type="text/css">
  .filas_tabla_responsables
  {
	...
	<script type="text/javascript">
		...
		onRequest : function (){
	$('guardar').set('html','<br /><br /><br /><img src="../../images/loading.gif" width="32" 	height="32" alt="Cargando..." />');
			}	,
		onSuccess : function(tree, elements, html)	{
			$('guardar').set('html',html);
			}	
		}).send({
		method : 'post',
		data : datos
...
<br />
    <form action="" method="get" name="update_fase" id="update_fase">

<table width="900" border="0">
  <tr align="center">
    <td valign="top">
        <p align="center"><center>
          <p><b>1. Ingresa Referencias</b></p>
          <p>
