...
<meta content="2000" http-equiv="REFRESH"> </meta>-->
<meta content="5;URL=http://10.94.130.36/iosphp/TELMEX_IOS/MooTools-TabPanel/Demo/demo_TEST_COMENTARIOS.php" http-equiv="REFRESH"> </meta>
<head>
<style type="text/css">
		*				{ font-family:tahoma; }
		h3				{ border-bottom:0; }
...
//			break;
	...
	//			timePicker: true,
			...
			var Pgina_Web_OK = new Picker.Date($$('#dt_pagina_web'), {
				pickerClass: 'datepicker_vista', 
	//			timePicker: true,
				format: '%Y-%m-%d',
				positionOffset: {x: 5, y: 0},
...
<table width="100" border="0" class="Texto_Mediano_Negro">
  <tr>
    ...
    <table width="900" border="0" class="Texto_Mediano_Negro">
      <tr>
        <td>Requerimiento</td>
        <td><?php echo ImprimeCombo(24,$id_requerimiento);?></td>
        <td>Resp. Sucope</td>
      ...
      <tr>
        ...
        <td><?php echo ImprimeCombo(25,$id_edo_fo);?></td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
...
<!-- FIN DEL TERCEDR TAB CONSULTA PROY DE FIBRA OPTICA --> 
    <div class="content">
					<table width="1000" border="0">
  <tr>
    <td width="338">
 ...
 <legend><strong>Proyectos</strong></legend>
  ...
  <tr>
        ...
        <td><!--<form id="form2" name="form2" method="post" action="">-->
          <div id="resultado_proyecto_fo" style="font-weight:bold;"></div>
      </td>
        <td>&nbsp;</td>
...
<!-- FIN DEL CUARTO TAB PROYECTO DE FIBRA OPTICA -->      
...
<table width="290" border="0">
 ...
 <table width="500" border="0" class="Texto_Mediano_Negro">
      ...
      <td><textarea name="obs_cons" id="obs_cons" cols="40" rows="10" tabindex="20"></textarea></td>
  </tr>
 </table>
 </form>
    </div>
