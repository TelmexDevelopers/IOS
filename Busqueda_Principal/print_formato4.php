...
//	$Responsable_Contratista_B =       $_GET['Responsable_Contratista_B'];
	...
	$str_telefono_fijo_ipe =                $_GET['str_telefono_fijo_ipe'];
...
//	$dt_Fecha_Inicio_Programada =      $_GET['dt_Fecha_Inicio_Programada'];
	$str_telefono_fijo_sup =           $_GET['str_telefono_fijo_sup'];
	...
	from vw_ot 
				...
				AND str_telefono_fijo_sup = '".$str_telefono_fijo_sup."'
				AND DOMICILIO = '".$DOMICILIO."'
				AND RESPONSABLE_CLIENTE = '".$RESPONSABLE_CLIENTE."'
				AND str_telefono_fijo_ipe = '".$str_telefono_fijo_ipe."'
	...
	$str_telefono_fijo_sup = $str_telefono_fijo_sup;
	$DOMICILIO = $DOMICILIO;
	$RESPONSABLE_CLIENTE = $RESPONSABLE_CLIENTE;
	$str_telefono_fijo_ipe = $str_telefono_fijo_ipe;
	
	$html = file_get_contents('formato4.html');	
